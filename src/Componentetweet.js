...
class Tweet extends React.Component{
            ...
            <div>
                ...
                <div style={{borderBottom:"solid", borderColor:"black"}}>
                    ...
                    <div id={"interactions"} style={{textAlign:"justify"}}>
                        ...
                        <img alt={""} onClick={this.compartirTweet} style={{cursor:"pointer", width:"50px", position:"relative", top:"-25px", left:"260px"}} src={"https://pngimg.com/uploads/share/share_PNG31.png"}/>
                    </div>
                </div>
    ...
    obtenerDatosTweet = () => {
        ...
        .then(json => {
            this.renderizarDatosTweet(json.username, json.filelocation, json.text, json.tweet_date);
        })
    }
    focus = () => {
        let id = this.props.type === "rt" ? this.props.referencedtweet : this.props.tweetid;
    ...
    renderizarDatosTweet = (username, filelocation, text, date) => {
    ...
    compartirTweet = () => {
        let id = this.props.type === "rt" ? this.props.referencedtweet : this.props.tweetid;
        ReactDOM.render(<EscribirTweet tweetid={id}/>, document.querySelector("#Div-1"));
    }
    ComentarioTweet = () => {
        let id = this.props.type === "rt" ? this.props.referencedtweet : this.props.tweetid;
