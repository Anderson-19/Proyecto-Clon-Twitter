...
class EscribirTweet extends React.Component {
    constructor(props){
        super(props);
    ...
    render() {
        return (
            <div>
                ...
                <br/>
                <div id={"text"}>
                    <textarea id={"TextContent"} onInput={this.comprobarTamano} style={{backgroundColor:"#2b2b2b", color:"white", resize:"none"}} cols={"150"} rows={"8"} placeholder={"Write something..."}/>
                </div>
                <br/>
                ...
                <div id={"media"}>
                    <div style={{position:"absolute", right:"50px"}}>
                        <img alt="" onClick={this.Click} style={{cursor:"pointer", width:"75px"}} src={"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Icons8_flat_add_image.svg/1024px-Icons8_flat_add_image.svg.png"}/>
                    </div>
                    ...
                    <form id={"mediaInput"} hidden={true}>
                        <input name={"tweetMedia"} id={"TFile"} accept={"image/jpeg, image/png, image/gif, video/mp4"} onInput={this.imagenEntrada} type={"file"}/>
                    </form>
                    ...
                    <button onClick={this.borrarMedia} style={{cursor:"pointer", backgroundColor:"deepskyblue", borderColor:"deepskyblue", borderRadius:"15%", width:"115px", height:"22px", position:"absolute", left:"215px", top:"350px"}}>Delete media</button>
                </div>
            </div>
        )
    }
